                        ...
                        <ul class="nav-tabs my-tabs">
                            ...
                            <li class="<?php echo get_sub_field('active_class_executives_page'); ?>">
                                <a data-toggle="tab" href="#<?php echo get_sub_field('link_ankor_executives_page'); ?>">
                                    <div class="img__tabs" style="background-image: url('<?php echo get_sub_field('image_chief_executives_page'); ?>')"></div>
                                    <div class="name__boss"><?php echo get_sub_field('name_chief_executives_page'); ?></div>
                                    <div class="state__boss"><?php echo get_sub_field('position_chief_executives_page'); ?></div>
                                </a>
                            </li>
                            <?php } ?>
                        </ul>
