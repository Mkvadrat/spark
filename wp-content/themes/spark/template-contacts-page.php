                ...
                <div class="row">
                    <div>
                        <div class="anchors__content">
                            <div id="spark__ao">
                                <h2><?php echo get_field('title_a_block_a_contacts_page'); ?></h2>
                                ...
                                <div class="grid__position">
                                    ...
                                    <div class="item__position">
                                        <div class="position__info">
                                            <span><?php echo get_sub_field('name_contacts_page'); ?></span>
                                    ...
                                    <div class="item__position">
                                        <div id="piter" class="maps" style="width:100%; height:338px"></div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <?php } ?>
                                ...
                                <div class="grid__category mb-7">
                                    ...
                                    <div class="item__category">
                                        <div class="category__img"><img src="<?php echo get_sub_field('image_contacts_page'); ?>" alt="cont"/></div>
                                ...
                                <h2><?php echo get_field('title_b_block_a_contacts_page'); ?></h2>
                                ...
                                <div class="grid__position mb-7">
                                    <div class="item__position">
                                        ...
                                        <div class="item__category w-100">
                                            <div class="category__img"><img src="<?php echo get_sub_field('image_contacts_page'); ?>" alt="cont"/></div>
                                            <div class="category__text">
                                                <div class="title__"><?php echo get_sub_field('name_contacts_page'); ?></div>
                                                <div class="state__"><?php echo get_sub_field('position_contacts_page'); ?></div>
                                    ...
                                    <div class="item__position">
                                        <div id="moskow" class="maps" style="width:100%; height:338px"></div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <?php } ?>
                                ...
                                <?php
                                    $forms_a = get_field('content_ao_form_block_contacts_page');
                                         if($forms_a){
                                ?>    
                                <h2><?php echo get_field('title_ao_form_block_contacts_page'); ?></h2>
                            ...
                            <div id="spark__npo">
                                <h2><?php echo get_field('title_a_block_b_contacts_page'); ?></h2>
                                ...
                                <div class="grid__position">
                                    ...
                                    <div class="item__position">
                                        <div id="piter2" class="maps" style="width:100%; height:338px"></div>
                                    </div>
                                    <?php } ?>
                                </div>
                                <?php } ?>
